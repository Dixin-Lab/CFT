...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="/path/to/Qwen-Image-Edit-2509")
    parser.add_argument("--lora_path", type=str, default="/path/to/qwen_cft/checkpoint-4000")
    parser.add_argument("--output_dir", type=str, default="/path/to/qwen_results")
